export default {
  "/bycco_frontend/dist": `A parent is present at site`,
  "/bycco_frontend/dist": `A photo for your badge`,
  "/bycco_frontend/dist": `/bycco_frontend/dist`,
  ...
  Home: `Home`,
  "However, you can still send en email to info{'@'}bycco.be, requesting for an late enrollment.": `However, you can still send en email to info{'@'}bycco.be, requesting for an late enrollment.`,
  "I agree": `I agree`,
  "ID Club": `ID Club`,
  "ID number": `ID number`,
  ...
  "Normally the reservation is for 6 nights, from 10-April until 16-April.  You can optionally add 1 night before and/or after.": `Normally the reservation is for 6 nights, from 10-April until 16-April.  You can optionally add 1 night before and/or after.`,
  "Nornally the reservation is for 3 nights, from 11-Nov until 14-Nov.  You can optionally add 1 night before andFromfter.": `Nornally the reservation is for 3 nights, from 11-Nov until 14-Nov.  You can optionally add 1 night before andFromfter.`,
  ...
  "Provide for any guest, the name, first name, birthday. Indicate if a guest intends to particpatte to the tournament.": `Provide for any guest, the name, first name, birthday. Indicate if a guest intends to particpatte to the tournament.`,
  "Read more": `Read more`,
  Remarks: `Remarks`,
  ...
  SubConf1: `The enrollment fee is 45 Euro from 15th of October`,
  SubConf1_old: ``,
  SubConf2: ``,
  SubDetail5: ``,
  SubDetail6: ``,
  SubId1: `Please provide your ID number of the RBCF.`,
  SubId2: `You ID number was not found.`,
  ...
  SubNat10: `For the FIDE you are not a Belgian. This means you cannot win the Belgian title and you cannot participate to the European and World Championships as part of the Belgian team.`,
  SubNat3: `You give Bycco the right to use the personal data collected in this subscription form.`,
  SubNat4: `Bycco will only use this data in order to organize this championships.`,
  SubNat5: `Bycco will use the profile picture for a badge and for identification on the website.`,
  SubNat6: `Bycco will use all personal data like mobile numbers and email addresses for internal purposes only.`,
  SubNat6: `Bycco is taking overview photos/videos of the championships and can publish these photos/videos on its website and on social media`,
  SubNat7: `If Bycco is taking a close-up photos/video of a player, Bycco will explicitly ask permission to publish`,
  SubNat8: `In any case Bycco will not leak any personal information to third parties.`,
  SubNat9: `Bycco will use the profile picture for a badge and for identification on the website.`,
  ...
  "The enrollments are officially closed.": `The enrollments are officially closed.`,
