...
<template>
  <v-container>
    ...
    <v-btn @click="uploading(trn_u10)">Upload</v-btn>
    <h3>U12</h3>
    <v-file-input label="Json file" v-model="trn_u12.file" />
    <v-btn @click="uploading(trn_u12)">Upload</v-btn>
    <h3>U14</h3>
    <v-file-input label="Json file" v-model="trn_u14.file" />
    <v-btn @click="uploading(trn_u14)">Upload</v-btn>
    <h3>U16</h3>
    <v-file-input label="Json file" v-model="trn_u16.file" />
    <v-btn @click="uploading(trn_u16)">Upload</v-btn>
    <h3>U18</h3>
    <v-file-input label="Json file" v-model="trn_u18.file" />
    <v-btn @click="uploading(trn_u18)">Upload</v-btn>
    <h3>U20</h3>
    <v-file-input label="Json file" v-model="trn_u20.file" />
    <v-btn @click="uploading(trn_u20)">Upload</v-btn>
  </v-container>
</template>
